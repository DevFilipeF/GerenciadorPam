...
if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
  throw new Error(
    "Supabase environment variables are required: VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY. " +
      `Current values: VITE_SUPABASE_URL=${SUPABASE_URL ? "set" : "missing"}, ` +
